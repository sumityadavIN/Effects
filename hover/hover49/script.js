...
document.addEventListener("DOMContentLoaded", () => {
  ...
  nameHeadings.forEach((heading) => {
    // Manual SplitText implementation to avoid premium plugin dependency
    const text = heading.innerText;
    heading.innerHTML = "";
    text.split("").forEach((char) => {
      const span = document.createElement("div"); // Using div to match likely GSAP SplitText behavior for block/inline-block
      span.innerText = char;
